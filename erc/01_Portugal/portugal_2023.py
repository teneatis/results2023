...
import re
import pandas as pd
link = 'https://www.ewrc-results.com/results/79047-rally-serras-de-fafe-felgueiras-boticas-vieira-do-minho-e-cabeceiras-de-basto-2023/?s='
startat, no_ss=413101, int(17)
#monte_23 = pd.DataFrame(columns=['Pos.', 'Pilote / Co-pilote', 'Voiture', '#', 'Temps', 'Écart'])
rally_23 = []

#for ss in range(0,(no_ss)):
for ss in (0, 1, 2, 3, 5, 6, 9, 10, 11, 12, 13, 14, 15, 16):
    val= startat + ss
    ss_a = str(val)
    my_url11 = link + ss_a
    #print(my_url11)
