...
link = 'https://rally-base.com/2023/rally-di-roma-capitale-2023/?ssId='
startat, no_ss=7751, int(13) # starting number of url, count of Special Stages
canceled = []
...
for ss in stages:
    ...
    data.to_csv('06_rally23_SS'+str(ss+1)+'.csv', index=False)
...
rally2023_stages.to_csv('06_rally2023.csv', index=False)
