...
total_ss_times_C6 = total[(total['Gr/Cl'].str.contains('|'.join(['C1', 'C2']))) & (total['surface'] == surface)]
total_ss_times_C6
...
#plt.savefig("C6.jpg")
plt.title(surface +'\nDiference between '+ gr_Cl +' Participants and Stage winer (s)')
plt.show()
...
#Heatmap_ALL.set_yticklabels(total_ss_times_WRC['Crew'], size = 15)
plt.title(surface +'\nDiference between ' + gr_Cl +' Participants and Stage winer (%)')
